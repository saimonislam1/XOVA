...
const PRODUCTS = [
  {
    ...
    desc: "Sharp-shouldered tailoring in brushed twill, cut for a clean silhouette.",
    image: "product1.jpeg",
    tag: "sale",
    isNew: false,
    bestseller: true,
  ...
  },
  {
    ...
    desc: "Bias-cut satin slip with a liquid drape, made for low light.",
    image: "product2.jpeg",
    tag: "new",
    isNew: true,
    bestseller: false,
  ...
  },
  {
    ...
    desc: "Heavyweight cotton jersey, boxy fit, garment-dyed for depth.",
    image: "product3.jpeg",
    tag: "",
    isNew: false,
    bestseller: true,
  ...
  },
  {
    ...
    desc: "Full-length wool-blend coat with a soft structured shoulder.",
    image: "product4.jpeg",
    tag: "sale",
    isNew: false,
    bestseller: false,
  ...
  {
    id: 5,
    name: "Ether Midi Dress",
    price: 499,
    oldPrice: null,
    category: "T-Shirts",
    sizes: ["XS", "S", "M", "L"],
    colors: ["#101014", "#4d9fff"],
    desc: "Fluid midi with a sculpted neckline and open back detail.",
    image: "product5.jpeg",
    tag: "new",
    isNew: true,
    bestseller: false,
  ...
  },
  {
    ...
    desc: "Fine-gauge cotton with a tonal print, washed for softness.",
    image: "product6.jpeg",
    tag: "sale",
    isNew: false,
    bestseller: false,
  ...
  {
    id: 7,
    name: "Cinder Denim Jacket",
    price: 499,
    oldPrice: null,
    category: "T-Shirts",
    sizes: ["S", "M", "L", "XL"],
    colors: ["#1c1c22", "#3a3a42"],
    desc: "Rigid selvedge denim, garment-washed to a soft charcoal.",
    image: "product7.jpeg",
    tag: "best",
    isNew: false,
    bestseller: true,
  ...
  {
    id: 8,
    name: "Lumen Column Dress",
    price: 499,
    oldPrice: null,
    category: "T-Shirts",
    sizes: ["S", "M", "L"],
    colors: ["#111116", "#8b5cf6"],
    desc: "Column silhouette in stretch crepe with a soft cowl back.",
    image: "product8.jpeg",
    tag: "best",
    isNew: false,
    bestseller: true,
